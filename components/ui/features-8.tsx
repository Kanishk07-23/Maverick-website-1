                    ...
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit pt-6">
                                <div className="relative flex h-24 w-56 items-center text-gray-900">
                                    ...
                                    <span className="mx-auto block w-fit text-5xl font-semibold text-gray-900">100%</span>
                                </div>
                                <h2 className="mt-6 text-center text-3xl font-semibold text-gray-900">Customizable</h2>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="text-lg font-medium text-gray-900 transition">Secure by default</h2>
                                    <p className="text-gray-500">Provident fugit and vero voluptate. magnam magni doloribus dolores voluptates a sapiente nisi.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-medium text-gray-900 transition">Faster than light</h2>
                                    <p className="text-gray-500">Provident fugit vero voluptate. magnam magni doloribus dolores voluptates inventore nisi.</p>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-gray-200">
                                        <Shield className="m-auto size-5 text-gray-900" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium text-gray-900 transition">Guaranteed Protection</h2>
                                        <p className="text-gray-500">Provident fugit vero voluptate. Voluptates a sapiente inventore nisi.</p>
                                    </div>
                                </div>
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium text-gray-900 transition">Team Collaboration</h2>
                                        <p className="text-gray-500">Voluptate. magnam magni doloribus dolores voluptates a sapiente inventore nisi.</p>
                                    </div>
                                </div>
                                <div className="before:bg-gray-200 relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-gray-200 bg-white px-2 py-1 text-xs shadow-sm text-gray-700">Alice</span>
                                        ...
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            ...
                                            <span className="block h-fit rounded border border-gray-200 bg-white px-2 py-1 text-xs shadow-sm text-gray-700">Bob</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-gray-200 bg-white px-2 py-1 text-xs shadow-sm text-gray-700">Charlie</span>
