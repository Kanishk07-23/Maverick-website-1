                    ...
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit pt-6">
                                <div className="relative flex h-24 w-56 items-center text-gray-50">
                                    <svg className="text-gray-300 absolute inset-0 size-full" viewBox="0 0 254 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <span className="mx-auto block w-fit text-5xl font-semibold text-gray-50">100%</span>
                                </div>
                                <h2 className="mt-6 text-center text-3xl font-semibold text-gray-50">Customizable</h2>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-gray-200 before:absolute before:-inset-2 before:rounded-full before:border before:border-gray-200">
                                    <svg className="m-auto h-fit w-24" viewBox="0 0 212 143" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        />
                                        <path className="text-blue-500" d="M3 72H209" stroke="currentColor" strokeWidth="6" strokeLinecap="round" />
                                        <defs>
                                            <linearGradient id="paint0_linear_0_1" x1="106.385" y1="1.34375" x2="106" y2="72" gradientUnits="userSpaceOnUse">
                                                <stop stopColor="white" stopOpacity="0" />
                                                <stop className="text-blue-500" offset="1" stopColor="currentColor" />
                                            </linearGradient>
                                        </defs>
                                    </svg>
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="text-lg font-medium text-gray-50 transition">Secure by default</h2>
                                    <p className="text-gray-400">Provident fugit and vero voluptate. magnam magni doloribus dolores voluptates a sapiente nisi.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6 text-gray-300">
                                    <svg className="w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="386" height="123" rx="10" />
                                        <g>
                                            <circle className="text-gray-200" cx="29" cy="29" r="15" fill="currentColor" />
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_0_106" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                                                <stop className="text-blue-500/20" stopColor="currentColor" />
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-medium text-gray-50 transition">Faster than light</h2>
                                    <p className="text-gray-400">Provident fugit vero voluptate. magnam magni doloribus dolores voluptates inventore nisi.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-gray-200">
                                        <Shield className="m-auto size-5 text-gray-50" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium text-gray-50 transition">Guaranteed Protection</h2>
                                        <p className="text-gray-400">Provident fugit vero voluptate. Voluptates a sapiente inventore nisi.</p>
                                    </div>
                                </div>
                                <div className="rounded-tl-2xl relative -mb-6 -mr-6 mt-6 h-fit border-l border-t border-gray-200 p-6 py-6 sm:ml-6 bg-gray-50/50">
                                    <div className="absolute left-3 top-2 flex gap-1">
                                        <span className="block size-2 rounded-full border border-gray-300 bg-gray-200"></span>
                                        <span className="block size-2 rounded-full border border-gray-300 bg-gray-200"></span>
                                        <span className="block size-2 rounded-full border border-gray-300 bg-gray-200"></span>
                                    </div>
                                    <div className="w-full h-32 mt-4 bg-white border border-gray-200 shadow-sm rounded-lg flex items-center justify-center text-gray-400">
                                        Data
                                    </div>
                                </div>
                            </CardContent>
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-gray-200">
                                        <Users className="m-auto size-6 text-gray-50" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium text-gray-50 transition">Team Collaboration</h2>
                                        <p className="text-gray-400">Voluptate. magnam magni doloribus dolores voluptates a sapiente inventore nisi.</p>
                                    </div>
                                </div>
                                <div className="before:bg-gray-200 relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-gray-200 bg-white px-2 py-1 text-xs shadow-sm text-gray-200">Alice</span>
                                            <div className="ring-white size-7 ring-4 rounded-full bg-blue-100 flex items-center justify-center">A</div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-white size-8 ring-4 rounded-full bg-orange-100 flex items-center justify-center">B</div>
                                            <span className="block h-fit rounded border border-gray-200 bg-white px-2 py-1 text-xs shadow-sm text-gray-200">Bob</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-gray-200 bg-white px-2 py-1 text-xs shadow-sm text-gray-200">Charlie</span>
                                            <div className="ring-white size-7 ring-4 rounded-full bg-green-100 flex items-center justify-center">C</div>
                                        </div>
                                    </div>
                                </div>
                            </CardContent>
