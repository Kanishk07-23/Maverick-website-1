        ...
        {cardsList.map((card, index) => {
          ...
          return (
            ...
            >
              ...
              <span
                className="absolute top-0 left-[65px] w-[35%] h-full rounded-lg transform skew-x-[15deg] transition-all duration-500 group-hover:skew-x-0 group-hover:left-[30px] group-hover:w-[calc(70%-50px)]"
                style={{ background: `linear-gradient(315deg, ${card.gradientFrom}, ${card.gradientTo})` }}
              />
              {/* Blurred glow */}
              <span
                className="absolute top-0 left-[65px] w-[35%] h-full rounded-lg transform skew-x-[15deg] blur-[30px] transition-all duration-500 group-hover:skew-x-0 group-hover:left-[30px] group-hover:w-[calc(70%-50px)]"
                style={{ background: `linear-gradient(315deg, ${card.gradientFrom}, ${card.gradientTo})` }}
              />
