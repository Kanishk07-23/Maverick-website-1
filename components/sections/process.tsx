		...
		<section className="py-16 md:py-32 relative z-10">
			<div className="mx-auto w-full max-w-5xl space-y-12 px-4">
				<AnimatedContainer className="mx-auto max-w-3xl text-center">
					...
					<h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-gray-50">
						Our Proven <span className="brand-gradient-text">4-Step Process</span>
					</h2>
					<p className="text-gray-400 mt-6 text-base md:text-lg tracking-wide text-balance">
