      ...
      <section className="section-padding">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="font-grotesk font-bold text-white text-3xl mb-6">Why Your Business Needs SEO & SEM</h2>
            ...
            <div className="glass-card rounded-3xl p-8 border border-white/8">
              <h3 className="text-xl font-bold text-white mb-6">Our Search Services</h3>
